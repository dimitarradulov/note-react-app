  ...
  return (
    <div className="modal-container">
      <div className="modal__content">
        <h3 className="modal__title">{props.note.title}</h3>
        <p className="modal__note-content">{props.note.content}</p>
        <button onClick={props.onCloseModal} className="btn--close-modal">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
