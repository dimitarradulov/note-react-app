    ...
    <div className="added-notes">
      <ul className="added-notes__notes">
        <div className="added-notes__note">
          <h3 className="added-notes__title">Lorem ipsum</h3>
          <p className="added-notes__content">
            Enim id amet mauris nunc aliquet ligula nulla dui dictumst vehicula
            odio sed et pulvinar tempor tempor tempor tempasd
          </p>
          <div className="note-details">
            <p className="added-notes__date">14.08.2022</p>
            ...
            <button className="added-notes__delete">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
